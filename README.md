# 🚀 AhmedDevly Links | Personal Link Tree
...
<div align="center">
  ...
  **Full Stack Web Developer & Technical Consultant**
  ...
  [![GitHub](https://img.shields.io/badge/GitHub-Follow-181717?style=for-the-badge&logo=github)](https://github.com/ahmeddevly)

  <p align="center">
    <i>"Building practical web solutions with performance, SEO, and usability in mind."</i>
  </p>
</div>
...
- 🌍 **Bi-lingual (i18n)**: Native support for Arabic (RTL) and English (LTR).
- 📱 **PWA Ready**: Installable on mobile and desktop as a native app.
- ⚡ **Performance**: 100/100 Lighthouse score (SEO, Accessibility, Best Practices).
- 🧩 **Dual Layout**: Switch between Grid and List views with persistent user preference.
